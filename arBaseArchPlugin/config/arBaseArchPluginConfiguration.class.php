...
class arBaseArchPluginConfiguration extends sfPluginConfiguration
{
  public static
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug()) {
      ...
      $context->response->addStylesheet('/plugins/arBaseArchPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css'));
    } else {
      $context->response->addStylesheet('/plugins/arBaseArchPlugin/css/min.css', 'last', array('media' => 'screen'));
      $context->response->addJavaScript('/plugins/arBaseArchPlugin/js/descricao-imagem.js');
    }
  }
