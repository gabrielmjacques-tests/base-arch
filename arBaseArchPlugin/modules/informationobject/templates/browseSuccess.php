...
<section class="header-options">
    ...
    <?php if ($topLod) { ?>
        <span class="search-filter">
            ...
            <a href="<?php echo url_for(['module' => 'informationobject', 'action' => 'browse'] + $params); ?>"
                class="remove-filter" aria-label="<?php echo __('Remove filter'); ?>">X</a>
        </span>
    <?php } ?>
...
<?php if (isset($pager) && $pager->getNbResults()) { ?>
    ...
    <section class="browse-options">
        ...
        <?php if ($sf_user->isAuthenticated()) { ?>
            <a
                href="<?php echo url_for(array_merge($sf_data->getRaw('sf_request')->getParameterHolder()->getAll(), ['module' => 'informationobject', 'action' => 'exportCsv'])); ?>">
        ...
        <?php if (!isset($sf_request->onlyMedia) && isset($aggs['digitalobjects']) && 0 < $aggs['digitalobjects']['doc_count']) { ?>
            <div class="search-result media-summary">
                <p>
                    ...
                    <a
                        href="<?php echo url_for(['module' => 'informationobject', 'action' => 'browse'] + $params + ['onlyMedia' => true]); ?>">
